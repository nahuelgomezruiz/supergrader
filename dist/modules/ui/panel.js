...
export class Panel {
    ...
    `;
        ...
        const elements = {
            panel,
            content: panel.querySelector('.ai-panel-content'),
            header: panel.querySelector('.ai-panel-header'),
            controls: panel.querySelector('.ai-controls'),
            progress: panel.querySelector('.ai-progress'),
            errors: panel.querySelector('.ai-errors')
        };
    ...
    toggle() {
        ...
        const toggle = this.elements.header.querySelector('.ai-panel-toggle');
        if (!content || !toggle)
            return;
    ...
    setupToggleListener() {
        if (!this.elements)
            return;
        const toggleButton = this.elements.header.querySelector('.ai-panel-toggle');
        if (toggleButton) {
