...
class UIController {
    ...
    handleUrlChange() {
        ...
        if (isDifferentSubmission) {
            ...
            const gradingServiceInstance = window.chromeGradingServiceInstance;
